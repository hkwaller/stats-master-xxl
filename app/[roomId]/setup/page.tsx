...
const GAME_MODES: { mode: GameMode; label: string; desc: string }[] = [
  { mode: 'classic',      label: 'Classic',        desc: 'Guess the player from a single season' },
  { mode: 'career',       label: 'Career',         desc: 'Career seasons revealed one by one — buzz in!' },
  { mode: 'h2h',          label: 'Head-to-Head',   desc: 'Which stat line belongs to this player?' },
  { mode: 'higher-lower', label: 'Higher or Lower', desc: 'Did the challenge player score more or less?' },
]
