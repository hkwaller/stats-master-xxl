  ...
  return (
    <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10 }}>
      ...
      <div>
        <div
          style={{
            font: `900 ${28 * s}px/0.9 "Bungee", "Archivo Black"`,
            color: Cclr.ink,
        ...
        <div
          style={{
            font: `700 ${9 * s}px/1 "JetBrains Mono"`,
...
function CBtn({ children, variant = 'red', size = 'md', style = {}, ...p }) {
  ...
  const sz =
    size === 'lg'
      ? { pad: '18px 28px', fs: 17, r: 14 }
      : size === 'sm'
        ? { pad: '8px 14px', fs: 11, r: 10 }
        : { pad: '14px 20px', fs: 14, r: 12 }
  ...
  return (
    <button
      style={{
        ...
        padding: sz.pad,
        cursor: 'pointer',
        font: `900 ${sz.fs}px/1 "Archivo Black", sans-serif`,
    ...
    >
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
          <div
            style={{
              ...
              alignItems: 'center',
              gap: 8,
              boxShadow: `0 3px 0 ${Cclr.ink}22`,
            }}
          >
            <span style={{ width: 8, height: 8, background: Cclr.green, borderRadius: '50%' }} />
            <span style={{ font: '800 11px/1 "Archivo Black"', letterSpacing: '0.14em' }}>
              1,284 PLAYING
            </span>
          </div>
          <CBtn variant="white" size="sm">
            SIGN IN
          </CBtn>
        </div>
      </div>
      ...
      <div style={{ position: 'relative', padding: '40px 40px 80px' }}>
        ...
        <div
          style={{
            ...
            padding: '8px 14px',
            borderRadius: 12,
            font: '900 12px/1 "Archivo Black"',
            letterSpacing: '0.1em',
            boxShadow: `0 4px 0 ${Cclr.ink}`,
          }}
        >
          STREAKS ×4 <span style={{ color: Cclr.red }}>🔥</span>
        </div>
        ...
        >
          <div>
            ...
            <h1
              style={{
                font: '900 108px/0.9 "Bungee"',
                margin: 0,
                color: Cclr.ink,
                letterSpacing: '-0.01em',
              }}
            >
              <span style={{ color: Cclr.navy }}>FIVE</span> STATS.
              <br />
              <span style={{ color: Cclr.red }}>ONE</span> LEGEND.
              <br />
              <span
                style={{
                  display: 'inline-block',
            ...
            <p
              style={{
                font: '500 18px/1.5 "Space Grotesk"',
                color: Cclr.ink,
                opacity: 0.85,
                maxWidth: 500,
                marginTop: 24,
            ...
            <div style={{ display: 'flex', gap: 12, marginTop: 28 }}>
              <CBtn variant="red" size="lg">
                🎮 CREATE GAME
              </CBtn>
              <CBtn variant="white" size="lg">
                JOIN WITH CODE
              </CBtn>
            </div>
          </div>
          ...
          <div style={{ position: 'relative', height: 440 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5,1fr)', gap: 6 }}>
                {MOCK.stats.map((s) => (
                  <div
                    key={s.k}
                    style={{
                      background: s.highlight ? Cclr.red : Cclr.ice,
                      color: s.highlight ? '#fff' : Cclr.ink,
                      border: `2px solid ${Cclr.ink}`,
                      borderRadius: 8,
                      padding: '8px 4px',
                      display: 'flex',
              ...
              <div style={{ marginTop: 12, display: 'grid', gap: 6 }}>
                {MOCK.choices.slice(0, 2).map((c, i) => (
                  <div
                    key={c}
                    style={{
                      background: i === 0 ? Cclr.navy : '#fff',
                      color: i === 0 ? '#fff' : Cclr.ink,
                      border: `2px solid ${Cclr.ink}`,
                      borderRadius: 10,
                      padding: '10px 12px',
                      font: '800 13px/1 "Archivo Black"',
                      display: 'flex',
                      alignItems: 'center',
                      gap: 8,
                    }}
                  >
                    <span
                      style={{
                        background: i === 0 ? '#fff' : Cclr.ink,
                        color: i === 0 ? Cclr.navy : '#fff',
                        width: 22,
                        height: 22,
                        borderRadius: 6,
                        display: 'grid',
            ...
            <div
              style={{
                ...
                width: 280,
                border: `3px solid ${Cclr.ink}`,
                boxShadow: `10px 12px 30px ${Cclr.shadow}`,
              }}
            >
              <div
                style={{
              ...
              >
                ...
                <div
                  style={{
                    font: '800 10px/1 "JetBrains Mono"',
                    letterSpacing: '0.18em',
                    opacity: 0.7,
                  }}
                >
              ...
              {MOCK.players.slice(0, 3).map((p, i) => (
                <div
                  ...
                  style={{
                    ...
                    alignItems: 'center',
                    padding: '6px 0',
                    borderBottom: i < 2 ? '1px dashed #ffffff22' : 'none',
                  }}
                >
                  <span
                    style={{
                      font: '900 14px/1 "Bungee"',
                      color: i === 0 ? Cclr.yellow : i === 1 ? Cclr.ice : '#aab3cf',
                    }}
                  >
                    {i + 1}
                  </span>
            ...
            <div
              style={{
                ...
                width: 120,
                height: 120,
                background: `radial-gradient(circle, ${Cclr.yellow}, #f0b512)`,
                borderRadius: '50%',
                border: `4px solid ${Cclr.ink}`,
                display: 'grid',
                placeItems: 'center',
      ...
      <div
        style={{
          padding: '40px',
          background: '#fff',
          borderTop: `4px solid ${Cclr.ink}`,
          borderBottom: `4px solid ${Cclr.ink}`,
        }}
      >
          ...
          {[
            {
              emoji: '🏒',
              t: 'Stat blitz',
              d: 'Five stats, four names, twelve seconds. Go.',
              c: Cclr.red,
            },
            {
              emoji: '🔥',
              t: 'Streak combos',
              d: 'Answer fast, rack up a combo, earn foil bonuses.',
              c: Cclr.yellow,
            },
            {
              emoji: '⚡',
              t: 'Power plays',
              d: 'Random 2× windows that flip the leaderboard.',
              c: Cclr.navy,
            },
            {
              emoji: '🚫',
              t: 'Penalty box',
              d: 'Wrong answer in boss mode? Sit two rounds out.',
              c: Cclr.ink,
            },
          ].map((f) => (
            <div
            ...
            >
              <div
                style={{
                  ...
                  display: 'grid',
                  placeItems: 'center',
                  font: '900 22px/1 "Archivo Black"',
                }}
              >
                {f.emoji}
              </div>
              <div style={{ font: '900 22px/1 "Bungee"', marginTop: 12 }}>{f.t}</div>
              <div style={{ font: '500 13px/1.5 "Space Grotesk"', color: '#35415f', marginTop: 6 }}>
                {f.d}
              </div>
            </div>
          ))}
          ...
          <div>
            <div
              style={{
                ...
                font: '900 11px/1 "Archivo Black"',
                letterSpacing: '0.22em',
                boxShadow: `0 3px 0 ${Cclr.ink}`,
              }}
            >
              STEP 1 OF 2
            </div>
            <h2 style={{ font: '900 60px/0.9 "Bungee"', margin: '14px 0 0', color: Cclr.ink }}>
              Set up the <span style={{ color: Cclr.red }}>game</span>
            </h2>
          </div>
          ...
          >
            ...
            >
              {[
                {
                  k: 'Classic',
                  d: 'Guess the player from one season',
                  color: Cclr.red,
                  emoji: '🏒',
                },
                ...
                {
                  k: 'Head-to-Head',
                  d: 'Which line belongs to this player?',
                  color: Cclr.yellow,
                  emoji: '🤼',
                },
                {
                  k: 'Higher/Lower',
                  d: 'Did they score more or less?',
                  color: Cclr.green,
                  emoji: '⚖️',
                },
              ].map((m) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      color: on ? (m.color === Cclr.yellow ? Cclr.ink : '#fff') : Cclr.ink,
                      border: `2.5px solid ${Cclr.ink}`,
                      borderRadius: 14,
                      padding: '16px',
                      cursor: 'pointer',
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          height: 22,
                          borderRadius: '50%',
                          border: `2px solid ${on ? '#fff' : Cclr.ink}`,
                    ...
                    <div
                      style={{ font: '500 12px/1.4 "Space Grotesk"', opacity: 0.85, marginTop: 6 }}
                    >
                      {m.d}
                    </div>
                  </button>
              ...
              >
                {[5, 10, 15, 20].map((n) => (
                  <button
                    ...
                    onClick={() => setQty(n)}
                    style={{
                      background: qty === n ? Cclr.navy : Cclr.ice,
                      color: qty === n ? '#fff' : Cclr.ink,
                      border: `2.5px solid ${Cclr.ink}`,
                      borderRadius: 14,
                      padding: '16px 0',
                      cursor: 'pointer',
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      onClick={() => toggle(d.k)}
                      style={{
                        background: on ? '#fff' : Cclr.ice,
                        borderRadius: 12,
                        border: `2.5px solid ${on ? d.c : Cclr.ink + '55'}`,
                        padding: '12px 14px',
                        cursor: 'pointer',
                        display: 'grid',
                    ...
                    >
                      ...
                      <div>
                        <div style={{ font: '900 16px/1 "Bungee"' }}>
                          {d.k} <span style={{ color: d.c, fontSize: 12 }}>· {d.r}</span>
                        </div>
                        <div
                          style={{
                            font: '500 11px/1.3 "Space Grotesk"',
                            color: '#35415f',
                            marginTop: 3,
                          }}
                        >
      ...
      <div style={{ padding: '20px 36px 40px' }}>
        ...
        >
          <div>
            ...
            <h2 style={{ font: '900 56px/0.9 "Bungee"', margin: '14px 0 0' }}>
              Lobby <span style={{ color: Cclr.red }}>·</span> DQK
              <span style={{ color: Cclr.red }}>VDS</span>
            </h2>
          </div>
          <CBtn variant="red" size="lg" style={{ fontSize: 18 }}>
            🎮 DROP THE PUCK
          </CBtn>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '0.8fr 1.2fr', gap: 18 }}>
          ...
          >
            ...
            >
                  ...
                  {Array.from({ length: 21 }).map((_, y) =>
                    Array.from({ length: 21 }).map((_, x) => {
                      const on =
                        ...
                        (x < 3 && y > 17)
                      return on ? (
                        <rect key={x + '-' + y} x={x} y={y} width="1" height="1" fill={Cclr.ink} />
                      ) : null
                    }),
                  )}
              ...
              <div style={{ font: '900 32px/1 "Bungee"', marginTop: 14, letterSpacing: '0.08em' }}>
                DQKVDS
              </div>
              <div
                style={{ font: '500 11px/1.3 "JetBrains Mono"', color: '#35415f', marginTop: 6 }}
              >
                statsmaster.site/DQKVDS
              </div>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginTop: 12 }}>
              <CBtn variant="navy" size="sm">
                ⎘ COPY LINK
              </CBtn>
              <CBtn variant="white" size="sm">
                SHARE
            ...
            >
              ...
              {[
                ...
                >
                  <span style={{ color: '#35415f' }}>{k}</span>
            ...
            >
              {MOCK.players.map((p) => (
                <div
                  key={p.name}
                  style={{
                    background: p.host ? Cclr.navy : '#fff',
                    color: p.host ? '#fff' : Cclr.ink,
                    border: `3px solid ${Cclr.ink}`,
                    borderRadius: 16,
                    padding: 14,
                    boxShadow: `0 5px 0 ${Cclr.ink}`,
                ...
                >
                  <AvatarBlock
                    initials={p.avatar}
                    bg={p.host ? Cclr.red : Cclr.navy}
                    fg="#fff"
                    size={48}
                    style={{ border: `2px solid ${Cclr.ink}`, borderRadius: 12 }}
                  />
                  <div style={{ flex: 1 }}>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  border: `2px solid ${me ? '#fff' : '#2b3a63'}`,
                  borderRadius: 10,
                  padding: '6px 10px',
                  display: 'flex',
                  alignItems: 'center',
              ...
              >
                ...
                />
                <div>
                  <div style={{ font: '800 10px/1 "Archivo Black"' }}>
                    #{p.rank} {p.name.slice(0, 9)}
                  </div>
                  <div style={{ font: '900 13px/1 "Bungee"', color: '#fff' }}>{p.score}</div>
                </div>
                {p.streak > 1 && (
                  <span style={{ font: '900 11px/1 "Bungee"', color: Cclr.yellow, marginLeft: 4 }}>
                    ×{p.streak}
                  </span>
                )}
              </div>
      ...
      <div style={{ position: 'relative', padding: '28px 36px' }}>
        ...
        >
          ...
          >
            ...
            >
              Q {MOCK.question.num}/{MOCK.question.total}
            </span>
          ...
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            ...
            >
              ...
              <span style={{ font: '900 12px/1 "Archivo Black"', letterSpacing: '0.16em' }}>
                COMBO
              </span>
          ...
          <div style={{ position: 'relative', width: 100, height: 100 }}>
            <svg width="100" height="100" style={{ transform: 'rotate(-90deg)' }}>
              ...
              <circle
                ...
                strokeDashoffset={2 * Math.PI * 44 * 0.34}
                strokeLinecap="round"
              />
            </svg>
            <div
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5,1fr)', gap: 14 }}>
          {MOCK.stats.map((s) => {
            ...
            const ledSvg =
              `<svg xmlns='http://www.w3.org/2000/svg' width='8' height='8'><circle cx='4' cy='4' r='1.1' fill='${encodeURIComponent(dotColor)}' opacity='0.38'/></svg>`.replace(
                /#/g,
                '%23',
              )
            return (
                ...
                >
                  ...
                  <div
                    style={{
                      position: 'absolute',
                      inset: 0,
                      backgroundImage: `url("data:image/svg+xml;utf8,${ledSvg}")`,
          ...
          {MOCK.choices.map((c, i) => {
            ...
            return (
              <button
                ...
                style={{
                  background: bg,
                  color: sel ? '#fff' : Cclr.ink,
                  border: `3px solid ${Cclr.ink}`,
                  borderRadius: 16,
                  padding: '16px 18px',
                  boxShadow: sel ? `0 6px 0 ${Cclr.ink}` : `0 5px 0 ${Cclr.ink}`,
                  textAlign: 'left',
                  cursor: elim ? 'not-allowed' : 'pointer',
                  opacity: elim ? 0.5 : 1,
                  position: 'relative',
                  display: 'flex',
                  alignItems: 'center',
        ...
        <div
          style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr 1fr', gap: 14, marginTop: 20 }}
        >
          {/* Powerups */}
          <div
            style={{
              ...
              {MOCK.powerups.map((p, i) => {
                ...
                return (
                  <button
                    key={p.k}
                    style={{
                      background: active ? bgs[i] : '#fff',
                      color: active ? (bgs[i] === Cclr.yellow ? Cclr.ink : '#fff') : Cclr.ink,
                      border: `2.5px solid ${Cclr.ink}`,
                      borderRadius: 12,
                      padding: '10px 6px',
                      cursor: 'pointer',
                  ...
                  >
                    ...
                    <span style={{ font: '900 10px/1 "Archivo Black"', letterSpacing: '0.1em' }}>
                      {p.label.toUpperCase()}
                    </span>
                  </button>
                )
            ...
            >
              <div
                style={{
                  position: 'absolute',
                  inset: 0,
                  backgroundImage: `repeating-linear-gradient(90deg, transparent 0 14px, ${Cclr.red}66 14px 16px)`,
                  borderRadius: 10,
                  pointerEvents: 'none',
                }}
              />
              <AvatarBlock
                ...
                bg={Cclr.red}
                size={36}
                style={{ border: `2px solid #fff`, position: 'relative', zIndex: 1 }}
              />
          ...
          >
            <div style={{ font: '900 14px/1 "Bungee"', marginBottom: 10 }}>
              💡 Hints{' '}
              <span
                style={{
                  font: '700 9px/1 "JetBrains Mono"',
            ...
            >
              🚜 ZAMBONI INCOMING · NEXT Q IN 0:08
            </div>
          </div>
        </div>
      </div>
